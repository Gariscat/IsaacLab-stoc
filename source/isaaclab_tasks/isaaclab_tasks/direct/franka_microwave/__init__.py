...
gym.register(
    id="Isaac-Franka-Microwave-v0",
    entry_point=f"{__name__}.franka_microwave_env:FrankaMicrowaveEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.franka_microwave_env:FrankaMicrowaveStochasticEnvCfg",
        # "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        # "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:FrankaCabinetPPORunnerCfg",
